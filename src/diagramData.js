...
export const allNodes = [
  ...
  {id: '2_q4_total_equals_sum', type: 'decision', data: { label: 'Does the total quantity reported correspond to the sum of the quantities reported by food source?', width: 260, height: 80 }, position: { x: 1250, y: 0 } },
  {id: '2_p3_drop_total_qty_var', type: 'process', data: { label: 'Drop the variable\n «Total quantity consumed» ' }, position: { x: 1500, y: 300 } },
  {id: '2_q5_units_same', type: 'decision', data: { label: 'Are all quantities reported by food source, in the same unit as the total quantity? ' }, position: { x: 1000, y: 0 } },
  {id: '2_p4_check_modify_error', type: 'process', data: { label: 'Check all the quantities and\n modify the likely error. ' }, position: { x: 1290, y: 150 } },
  {id: '2_q6_recall', type: 'decision', data: { label: 'Is the data collected through a recall? ' }, position: { x: 1500, y: 450 } },
  {id: '2_q7_duplicates_nonrecall', type: 'decision', data: { label: 'Is there only one observation for the same combination of household/day/food item/value/quantity/unit/\nsource of consumption?', width: 360, height: 80 }, position: { x: 1750, y: 450} },
  ...
  {id: '3_p2_aggregate_fafh', type: 'process', data: { label: 'Aggregate the FAFH data to one observation per household/food item/unit for each source of consumption', width: 260, height: 80 }, position: { x: 960, y: 1350 } },
  {id: '3_p3_add_fafh_wide', type: 'process', data: { label: 'Add the data from the module on FAFH to the dataset' }, position: { x: 1000, y: 1500 } },
  {id: '3_p4_temp_file_for_imputation', type: 'process', data: { label: 'Create a temporary file with the monetary values and quantities from purchases to be further used for imputation ', width: 300, height: 80 }, position: { x: 140, y: 1650 } },
  {id: '3_q5_fafh_independent_long', type: 'decision', data: { label: 'Are FAFH collected in an independent module?' }, position: { x: 500, y: 1800 } },
  {id: '3_p5_assign_food_source', type: 'process', data: { label: 'Assign the corresponding food source in the variable «source»' }, position: { x: 750, y: 1800 } },
  {id: '3_p6_aggregate', type: 'process', data: { label: 'Aggregate data to one observation per household/source/food item/unit', width: 240, height: 80 }, position: { x: 1000, y: 1800 } },
  {id: '3_p7_add_fafh_long', type: 'process', data: { label: 'Add the data from the module on FAFH to the dataset' }, position: { x: 1310, y: 1800 } },
  ...
  {id: '4_p3_use_original_non_purchased', type: 'process', data: { label: 'Using the original quantity of food consumed  from non-purchased foods' }, position: { x: 770, y: 2850 } },
  ...
  {id: '4_p15_flag both', type: 'process', data: { label: 'Flag both the quantity and the monetary value and correct in the next slide' }, position: { x: 2330, y: 3740 } },
  {id: '4_p16_flag_quantity', type: 'process', data: { label: 'Flag and correct the quantity in the next slide' }, position: { x: 2330, y: 3890 } },
  ...
  {id: '4_p17_flag_value', type: 'process', data: { label: 'Flag and correct the monetary value in the next slide' }, position: { x: 2330, y: 4190 } },
...
export const allEdges = [
  ...
  { id: 'e2_q4_yes_p4', type: 'straight', source: '2_q4_total_equals_sum', sourceHandle: 'out-bottom', target: '2_p4_check_modify_error', targetHandle: 'in-top', label: 'Yes'},
  ...
  { id: 'e2_q6_yes_q7', type: 'straight', source: '2_q6_recall', sourceHandle: 'out-right', target: '2_q7_duplicates_nonrecall', targetHandle: 'in-left', label: 'Yes'},
  { id: 'e2_q7_yes_p9', type: 'straight', source: '2_q7_duplicates_nonrecall', sourceHandle: 'out-right', target: '2_p9_aggregate', targetHandle: 'in-left', label: 'Yes'},
  ...
  { id: 'e2_p5_yes_p9', type: 'step', source: '2_p5_delete_duplicates', sourceHandle: 'out-right', target: '2_p9_aggregate', targetHandle: 'in-bottom'},
  { id: 'e2_p9_yes_q9', type: 'straight', source: '2_p9_aggregate', sourceHandle: 'out-bottom-75', target: '2_q9_code_description_consistent', targetHandle: 'in-top-75'},
  ...
  { id: 'e2_q4_no_p3', type: 'step', source: '2_q4_total_equals_sum', sourceHandle: 'out-right', target: '2_p3_drop_total_qty_var', targetHandle: 'in-top', label: 'No' },
  ...
  { id: 'e2_q6_no_q8', type: 'step', source: '2_q6_recall', sourceHandle: 'out-bottom', target: '2_q8_duplicates_recall', targetHandle: 'in-left', label: 'No' },
...
// Step 3
  ...
  { id: 'e3_q6_no_q10', type: 'step', source: '3_q6_number_of_meals_fafh_collected', sourceHandle: 'out-bottom', target: '3_q10_visitors_no_meals_fafh', targetHandle: 'in-top', label: 'No' },
  ...
  { id: 'e4_p2_yes_p3', type: 'straight', source: '4_p2_self_reported_to_missing', sourceHandle: 'out-bottom', target: '4_p3_use_original_non_purchased', targetHandle: 'in-top'},
  ...
  { id: 'e4_q12_no_finished', type: 'step', source: '4_q12_flagged_multi', sourceHandle: 'out-bottom', target: '4_finished', targetHandle: 'in-left', label: 'No' },
  ...
  { id: 'e5_q2_yes_q3', type: 'straight', source: '5_q2_househ_unit_value_miss', sourceHandle: 'out-right', target: '5_q3_unit_measurement_same', targetHandle: 'in-left'},
