...
export const allNodes = [
  ...
  {id: '3_p3_add_fafh_wide', type: 'process', dependsOn: { filter3: 'yes' }, data: { label: 'Add the data from the module on FAFH to the dataset' }, position: { x: 1000, y: 1500 } },
  ...
  {id: '3_p7_add_fafh_long', type: 'process', dependsOn: { filter3: 'yes' }, data: { label: 'Add the data from the module on FAFH to the dataset' }, position: { x: 1310, y: 1800 } },
